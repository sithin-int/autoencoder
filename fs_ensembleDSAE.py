...
OUT_DIR = r"outputs_new/ensembleDSAE"
MASK_FEATS = ["id", "label"]
...
results_df = {**{"outer_seed":[], "exe_time":[], "memory":[], "b":[], "permute_seed":[], "re_mean":[]}, **{"re_"+feat:[] for feat in feats}, **{"label":[]}} # {**dict1, **dict2,...} is a way to merge multiple dictionaries
